...
- 定义：统计周期内参与社区治理的外部组织数量。
- 权重：33%
- 阈值：5个

参与治理的组织个数反映了社区的组织多元化程度。该指标统计周期内在社区中担任组织管理者或组织参与者角色。多个组织参与治理能够避免单一组织垄断决策，保证社区的中立性和可持续发展。该指标是评估社区开放治理的重要标志。

### 组织管理者数量

- 定义：统计周期内来自外部组织的管理者数量。
- 权重：33%
- 阈值：20个

组织管理者数量反映了组织在社区治理中的投入程度。该指标统计周期内在社区中担任组织管理者角色。组织管理者通常具有丰富的项目经验和资源支持，他们的参与能够提升社区治理的专业性和效率。该指标能够反映组织对社区治理的重视程度。

### 组织管理者数量占比

- 定义：统计周期内组织管理者占社区管理者总数的比例。
- 权重：33%
- 阈值：1占比（100%）

组织管理者数量占比反映了组织在社区治理中的影响力。该指标统计周期内来自组织的管理者数量占社区全部管理者（组织管理者与个人管理者之和）的比例。适度的组织管理者占比能够保证社区的专业性和资源支持，但过高的占比可能导致社区治理过于依赖组织，影响社区的独立性和中立性。
...
个人管理者数量反映了社区对个人贡献者的认可和培养。该指标统计周期内在社区中担任个人管理者角色的去重人数。个人管理者通常凭借个人能力和贡献获得治理权限，他们的参与能够保证社区的多元化和活力。该指标能够反映社区的个人参与度和治理包容性。

### 个人管理者数量占比

- 定义：统计周期内个人管理者占社区管理者总数的比例。
- 权重：50%
- 阈值：1占比（100%）

个人管理者数量占比反映了个人在社区治理中的影响力。该指标统计周期内来自个人的管理者数量占社区全部管理者（组织管理者与个人管理者之和）的比例。适度的个人管理者占比能够保证社区的独立性和中立性，避免组织过度控制。该指标能够反映社区的治理开放性和个人参与度。
